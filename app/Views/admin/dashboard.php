            ...
            <div class="row mb-2">
                ...
                <!-- <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active"><a href="#"><?= ucfirst($uri[0]) ?></a></li>
                    </ol>
                </div> -->
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-lg-6 col-12">
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            <h3 class="card-title text-info">Sub Step Class A</h3>
                        </div>
                        <div class="card-body lead">
                            <ul class="list-unstyled">
                                <li class="text-muted">(1-A-1)
                                    <ul>
                                        <li><a href="#">1. Company-wide yearly safety police, Oraganization and Activities Plan</a></li>
                                    </ul>
                                </li>
                                <li class="text-muted">(1-A-2,3)
                                    <ul>
                                        <li><a href="#">2. No. of accident yokoten report from internal & outside accident case (TDEM, Affiliate company)</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
